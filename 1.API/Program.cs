...
var connectionString = builder.Configuration.GetConnectionString("RappiDB");

builder.Services.AddDbContext<RappiDBContext>(
    dbContextOptions =>
    {
...
using (var context = scope.ServiceProvider.GetService<RappiDBContext>())
{
